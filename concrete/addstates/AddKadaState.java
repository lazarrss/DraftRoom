...
public class AddKadaState implements State {
    ...
    public void misKliknut(MyTabPanel roomView, Point point1) throws NoninvertibleTransformException {
        ...
        Kada kada = new Kada("", roomView.getRoom(), point, width, height, 0);
        kada.addSubscriber(roomView);
        MainFrame.getInstance().getTabbedPane().setRoomElement(kada);

        KadaPainter kp = new KadaPainter(kada);
