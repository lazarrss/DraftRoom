...
import raf.draft.dsw.gui.swing.view.painters.concrete.OrmarPainter;
import raf.draft.dsw.gui.swing.view.painters.concrete.VesMasinaPainter;
import raf.draft.dsw.model.messages.MessageType;
import raf.draft.dsw.model.structures.roomelements.concrete.Lavabo;
import raf.draft.dsw.model.structures.roomelements.concrete.Ormar;
import raf.draft.dsw.model.structures.roomelements.concrete.VesMasina;
...
public class AddVesMasinaState implements State {
    ...
    public void misKliknut(MyTabPanel roomView, Point point1) throws NoninvertibleTransformException {
        ...
        VesMasina vesMasina = new VesMasina("", roomView.getRoom(), point, width, height, 0);
        vesMasina.addSubscriber(roomView);
        MainFrame.getInstance().getTabbedPane().setRoomElement(vesMasina);

        VesMasinaPainter vm = new VesMasinaPainter(vesMasina);

        AbstractCommand abstractCommand = new AddCommand(roomView, vm);
