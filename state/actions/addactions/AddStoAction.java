...
public class AddStoAction extends AbstractRoomAction {
    public AddStoAction() {
        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_F2, InputEvent.CTRL_DOWN_MASK));
        putValue(SMALL_ICON, loadIcon("/images/roomElements/table.png"));
        putValue(NAME, "Table");
        putValue(SHORT_DESCRIPTION, "Add table");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        MainFrame.getInstance().getTabbedPane().startAddStoState();
