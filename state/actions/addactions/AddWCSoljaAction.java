...
public class AddWCSoljaAction extends AbstractRoomAction {
    public AddWCSoljaAction() {
        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_F2, InputEvent.CTRL_DOWN_MASK));
        putValue(SMALL_ICON, loadIcon("/images/roomElements/toiletBowl.png"));
        putValue(NAME, "Toilet bowl");
        putValue(SHORT_DESCRIPTION, "Add toilet bowl");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        MainFrame.getInstance().getTabbedPane().startAddWCSoljaState();
