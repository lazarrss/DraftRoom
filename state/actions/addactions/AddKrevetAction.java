...
public class AddKrevetAction extends AbstractRoomAction {
    public AddKrevetAction() {
        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_F2, InputEvent.CTRL_DOWN_MASK));
        putValue(SMALL_ICON, loadIcon("/images/roomElements/bed.png"));
        putValue(NAME, "Bed");
        putValue(SHORT_DESCRIPTION, "Add bed");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        MainFrame.getInstance().getTabbedPane().startAddKrevetState();
