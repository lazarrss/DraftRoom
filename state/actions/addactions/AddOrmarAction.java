...
public class AddOrmarAction extends AbstractRoomAction {
    public AddOrmarAction() {
        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_F2, InputEvent.CTRL_DOWN_MASK));
        putValue(SMALL_ICON, loadIcon("/images/roomElements/wardrobe.png"));
        putValue(NAME, "Wardrobe");
        putValue(SHORT_DESCRIPTION, "Add wardrobe");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        MainFrame.getInstance().getTabbedPane().startAddOrmarState();
