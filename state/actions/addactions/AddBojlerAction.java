...
public class AddBojlerAction extends AbstractRoomAction {
    public AddBojlerAction() {
        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_F2, InputEvent.CTRL_DOWN_MASK));
        putValue(SMALL_ICON, loadIcon("/images/roomElements/boiler.png"));
        putValue(NAME, "Bojler");
        putValue(SHORT_DESCRIPTION, "Add boiler");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        MainFrame.getInstance().getTabbedPane().startAddBojlerState();
