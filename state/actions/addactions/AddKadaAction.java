...
public class AddKadaAction extends AbstractRoomAction {
    public AddKadaAction() {
        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_F2, InputEvent.CTRL_DOWN_MASK));
        putValue(SMALL_ICON, loadIcon("/images/roomElements/bath.png"));
        putValue(NAME, "Bath");
        putValue(SHORT_DESCRIPTION, "Add bath");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        MainFrame.getInstance().getTabbedPane().startAddKadaState();
