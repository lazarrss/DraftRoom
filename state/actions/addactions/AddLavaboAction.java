...
public class AddLavaboAction extends AbstractRoomAction {
    public AddLavaboAction() {
        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_F2, InputEvent.CTRL_DOWN_MASK));
        putValue(SMALL_ICON, loadIcon("/images/roomElements/sink.png"));
        putValue(NAME, "Sink");
        putValue(SHORT_DESCRIPTION, "Add sink");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        MainFrame.getInstance().getTabbedPane().startAddLavaboState();
