...
public class AddVrataAction extends AbstractRoomAction {
    public AddVrataAction() {
        putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(KeyEvent.VK_F2, InputEvent.CTRL_DOWN_MASK));
        putValue(SMALL_ICON, loadIcon("/images/roomElements/door.png"));
        putValue(NAME, "Door");
        putValue(SHORT_DESCRIPTION, "Add door");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        MainFrame.getInstance().getTabbedPane().startAddVrataState();
